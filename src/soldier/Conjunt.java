 ...
 * based in the set operations, also this class contains owned attributes and
 * methods
 *
...
public class Conjunt implements TADConjuntable {
     ...
     * @return Conjunt: Set that is a result of the difference between two sets
     */
    public Conjunt Difference(Conjunt c) {
        Conjunt conjuct = new Conjunt(this);
        
        
        for (int i = 0; i <c.getData().length; i++) {
            conjuct.delete(c.getData()[i]);
        }
